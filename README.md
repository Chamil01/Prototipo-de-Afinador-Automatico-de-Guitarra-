...
➡️ _**Diseño 3D:**_ El cambio prinicpal que se puede hacer en el diseño 3D es en la pieza que conecta el motor con la clavija de la guitarra. Se podría agregar alguna especie de traba que permita que la pieza quede agarrada y no se salga con el torque del motor. Además, siempre se puede hacer un diseño mas sofisticado y lo mas universal posible de modo que se pueda adaptar. Con respecto al diseño de la caja, se podrían agregar contenedores adentro, que permitan encastrar cada pieza en un lugar y que no quede todo suelto.
